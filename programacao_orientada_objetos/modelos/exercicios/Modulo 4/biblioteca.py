...
livro_biblioteca = Livro("Livro da biblioteca", "Antonio", 2027)
...
ano_especifico = 2023
livros_disponivel_ano = Livro.verificar_disponibilidade(ano_especifico)
print(f"Livros disponiveis em {ano_especifico}: {livros_disponivel_ano}")